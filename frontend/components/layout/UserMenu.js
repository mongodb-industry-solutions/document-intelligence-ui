...
// Document Intelligence tool, so Maria is always the current user here.
const CURRENT_USER_ID = "67a1000000000000000000006";
 ...
 * (Maria — Document Analyst) with a switch-user dropdown. Selecting another
